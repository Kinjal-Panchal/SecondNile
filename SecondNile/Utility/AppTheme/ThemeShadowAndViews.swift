...
class GradientView: UIView {
    ...
    @IBInspectable var color1: UIColor = UIColor.appColor(.themeGrayGradientFrst) { didSet { updateColors() } }
    @IBInspectable var color2: UIColor = UIColor.appColor(.themeGrayGradientSecond)  { didSet { updateColors() } }
