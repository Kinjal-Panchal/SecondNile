//
//  PreviewGalleryVC.swift
//  SecondNile
//
//  Created by panchal kinjal  on 06/08/21.
//
...
class PreviewGalaryVC: UIViewController {
...
extension PreviewGalaryVC : UICollectionViewDelegate, UICollectionViewDelegateFlowLayout,UICollectionViewDataSource
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "GalaryCell", for: indexPath)as! GalaryCell
        cell.imgGalary.image = UIImage(named: arrImage[indexPath.row])
        return cell
    }
